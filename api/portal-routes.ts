...
router.post("/chat", async (req: Request, res: Response) => {
  try {
    ...
    // "archive") and the canonical marketing names used downstream by the
    // prompt template.
    ...
    // and whatever clientTier sends both collapse to the canonical marketing
    // names here.
...
- Pattern combinations, relationship protocols, workplace applications, parenting, advanced techniques`;
    ...
    const systemPrompt = buildPocketArchivistPrompt({ tierAccess, patternName, userTier, streakCount });
