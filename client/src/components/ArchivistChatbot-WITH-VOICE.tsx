...
const ArchivistChatbot = () => {
  ...
  const VOICE_URL = "https://thearchivistmethod.com/archivist-voice.mp3";
...
- Keep responses SHORT (2-3 sentences max) so audio generation is fast
- Use emotional tags in square brackets to guide voice: [sigh], [chuckle], [pause], [serious], [firm]
- Example: "[serious] That's the Disappearing Pattern. [pause] It runs when intimacy increases."
...
CRITICAL RULES:
- KEEP RESPONSES SHORT (2-3 sentences) for fast audio
- Use emotional tags: [sigh], [pause], [chuckle], [serious]
