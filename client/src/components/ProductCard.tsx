...
export default function ProductCard({
  ...
  const borderColor = tier === "popular" ? "border-archivist-pink/50" : "border-archivist-teal/30";
  const shadowColor = tier === "popular"
  ...
  const badgeColor = tier === "popular" ? "bg-archivist-pink text-white" : "bg-archivist-teal text-archivist-dark";
  ...
  return (
    <div className="relative h-full">
      ...
      <div className={`relative border-2 ${borderColor} ${shadowColor} rounded-lg p-8 bg-archivist-dark/50 h-full flex flex-col hover:-translate-y-2 transition-all duration-300`}>
        <div className="w-full mb-8">
          <h3 className="text-4xl font-bold text-white text-center mb-3">{title}</h3>
