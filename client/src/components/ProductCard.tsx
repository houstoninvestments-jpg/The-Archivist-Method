...
export default function ProductCard({
  ...
  const getCardClass = () => {
    const base = "relative rounded-lg p-8 h-full flex flex-col transition-all duration-300";
      ...
      <div className={getCardClass()}>
        ...
        <div className="space-y-6 flex-grow">
          ...
          <div className="text-center pt-4">
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-3 leading-tight">{title}</h3>
