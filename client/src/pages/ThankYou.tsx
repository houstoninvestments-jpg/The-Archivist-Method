      ...
      <div className="container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Your 7-Day Crash Course is ready below.
          </p>
          ...
          <div className="bg-gradient-to-br from-archivist-teal/10 to-archivist-pink/10 border border-archivist-teal/30 rounded-lg p-8 mb-8">
            ...
            <p className="text-gray-300 mb-6">
              Click below to view and download your 30-page ADHD-optimized
              guide:
            </p>
            <a
              href="https://thearchivistmethod.com/7-day-crash-course.pdf"
              target="_blank"
            ...
            <p className="text-sm text-gray-400 mt-4">
              Bookmark this page - you can come back anytime to access your
              guide.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-archivist-pink/10 to-archivist-teal/10 border border-archivist-pink/30 rounded-lg p-8">
            ...
            <p className="text-gray-300 mb-6">
              The crash course covers 1 pattern. The Quick-Start System gives
              you all 7 patterns, 90 days of protocols, and everything you need
              to break destructive cycles.
            </p>
            <a
              href="https://buy.stripe.com/cNidR1eKi8cb16qalY6c001"
