      ...
      <div className="container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Download your 7-Day Crash Course below and start today.
          </p>
          ...
          <div className="bg-gradient-to-br from-archivist-teal/10 to-archivist-pink/10 border border-archivist-teal/30 rounded-lg p-8 mb-8">
            ...
            <p className="text-gray-300 mb-6">
              Click below to download your 30-page ADHD-optimized guide:
            </p>
            <a
              href="/downloads/7-day-crash-course.pdf"
              download
            ...
            <p className="text-sm text-gray-400 mt-4">
              Bookmark this page - you can come back anytime to re-download.
            </p>
          </div>
