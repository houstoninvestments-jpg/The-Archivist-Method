    ...
    <div ref={pageRef} className="min-h-screen thread-page" style={{ background: "#0A0A0A", color: "#F5F5F5", fontFamily: "'Inter', sans-serif", overflowX: "hidden" }}>
      ...
      <section className="min-h-screen relative hero-section-fade hero-grid" data-testid="section-hero" style={{ overflow: "hidden" }}>
        ...
        <div className="hero-content-col">
          ...
          <div className="hero-rule" style={{ height: "1px", width: "40px", background: "#14B8A6", margin: "28px 0", opacity: 0, animation: "heroFadeIn 0.4s ease 4.5s forwards" }} />
          <p className="hero-reframe-line" style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(2.5rem, 7vw, 5.5rem)", fontWeight: 800, letterSpacing: "-0.06em", lineHeight: 0.9, fontVariationSettings: "'opsz' 96", textTransform: "uppercase", WebkitFontSmoothing: "antialiased", color: "#FAFAFA", marginBottom: "4px", clipPath: "inset(100% 0 0 0)", WebkitClipPath: "inset(100% 0 0 0)", animation: "heroClipReveal 0.6s cubic-bezier(0.16,1,0.3,1) 5.2s forwards" }}>THAT{"\u2019"}S NOT WHO YOU ARE.</p>
          <p className="hero-reframe-line" style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(2.5rem, 7vw, 5.5rem)", fontWeight: 800, letterSpacing: "-0.06em", lineHeight: 0.9, fontVariationSettings: "'opsz' 96", textTransform: "uppercase", WebkitFontSmoothing: "antialiased", color: "#FAFAFA", marginBottom: "4px", clipPath: "inset(100% 0 0 0)", WebkitClipPath: "inset(100% 0 0 0)", animation: "heroClipReveal 0.6s cubic-bezier(0.16,1,0.3,1) 5.6s forwards" }}>THAT{"\u2019"}S A <span style={{ background: "#14B8A6", color: "#0a0a0a", padding: "0 0.15em", display: "inline", lineHeight: "inherit" }}>PATTERN</span> RUNNING.</p>
          <div className="hero-rule" style={{ height: "1px", width: "40px", background: "#14B8A6", margin: "24px 0", opacity: 0, animation: "heroFadeIn 0.4s ease 6.8s forwards" }} />
          <div style={{ marginBottom: "28px" }}><span className="hero-pivot-line" data-testid="text-brand-title" style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic", fontWeight: 400, fontSize: "clamp(1.8rem, 4vw, 3rem)", color: "#14B8A6", letterSpacing: "0.02em", opacity: 0, animation: "heroTealPulse 1.2s ease 7.5s forwards" }}>THE PATTERN HAS A NAME.</span></div>
