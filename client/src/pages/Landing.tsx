    ...
    <div ref={pageRef} className="min-h-screen thread-page" style={{ background: "#0A0A0A", color: "#F5F5F5", fontFamily: "'Inter', sans-serif", overflowX: "hidden" }}>
      ...
      <section className="min-h-screen relative hero-section-fade hero-grid" data-testid="section-hero" style={{ overflow: "hidden" }}>
        ...
        <div className="hero-content-col">
          ...
          <p className="hero-reframe-line" style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(2.5rem, 5.5vw, 4.2rem)", fontWeight: 800, letterSpacing: "-0.06em", lineHeight: 0.9, fontVariationSettings: "'opsz' 96", textTransform: "uppercase", WebkitFontSmoothing: "antialiased", color: "#FAFAFA", marginBottom: "4px", opacity: 0, clipPath: "inset(100% 0 0 0)", WebkitClipPath: "inset(100% 0 0 0)", animation: "heroClipReveal 0.6s cubic-bezier(0.16,1,0.3,1) 5.2s forwards" }}>THAT{"\u2019"}S NOT WHO YOU ARE.</p>
          <p className="hero-reframe-line" style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(2.5rem, 5.5vw, 4.2rem)", fontWeight: 800, letterSpacing: "-0.06em", lineHeight: 0.9, fontVariationSettings: "'opsz' 96", textTransform: "uppercase", WebkitFontSmoothing: "antialiased", color: "#FAFAFA", marginBottom: "4px", opacity: 0, clipPath: "inset(100% 0 0 0)", WebkitClipPath: "inset(100% 0 0 0)", animation: "heroClipReveal 0.6s cubic-bezier(0.16,1,0.3,1) 5.6s forwards" }}>THAT{"\u2019"}S A <span style={{ background: "#14B8A6", color: "#0a0a0a", padding: "0 0.15em", display: "inline", lineHeight: "inherit" }}>PATTERN</span> RUNNING.</p>
