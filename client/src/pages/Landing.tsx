    ...
    <div ref={pageRef} className="min-h-screen thread-page" style={{ background: "#0A0A0A", color: "#F5F5F5", fontFamily: "'Inter', sans-serif", overflowX: "hidden" }}>
      ...
      <section className="min-h-screen relative hero-section-fade hero-grid" data-testid="section-hero" style={{ overflow: "hidden" }}>
        ...
        <div className="hero-content-col">
          ...
          <p style={{ marginBottom: "4px", lineHeight: 1.9 }}><span style={{ display: "inline-block", overflow: "hidden", whiteSpace: "nowrap", borderRight: "2px solid transparent", width: 0, opacity: 0, fontFamily: "'JetBrains Mono', monospace", fontSize: "0.9rem", color: "rgba(250,250,250,0.7)", letterSpacing: "0.02em", verticalAlign: "bottom", animation: "heroFadeIn 0.01s linear 1.0s forwards, heroTypewriter 1.2s steps(30, end) 1.0s forwards, heroCursorFade 0.5s linear 1.0s infinite, heroCursorHide 0.01s linear 2.5s forwards" }}>{"\u201CYou\u2019ve watched yourself do it.\u201D"}</span></p>
          <p style={{ marginBottom: "4px", lineHeight: 1.9 }}><span style={{ display: "inline-block", overflow: "hidden", whiteSpace: "nowrap", borderRight: "2px solid transparent", width: 0, opacity: 0, fontFamily: "'JetBrains Mono', monospace", fontSize: "0.9rem", color: "rgba(250,250,250,0.7)", letterSpacing: "0.02em", verticalAlign: "bottom", animation: "heroFadeIn 0.01s linear 2.5s forwards, heroTypewriter 0.8s steps(22, end) 2.5s forwards, heroCursorFade 0.5s linear 2.5s infinite, heroCursorHide 0.01s linear 3.8s forwards" }}>{"\u201CYou\u2019ve tried to stop.\u201D"}</span></p>
          <p style={{ marginBottom: "4px", lineHeight: 1.9 }}><span style={{ display: "inline-block", overflow: "hidden", whiteSpace: "nowrap", borderRight: "2px solid transparent", width: 0, opacity: 0, fontFamily: "'JetBrains Mono', monospace", fontSize: "0.9rem", color: "rgba(250,250,250,0.7)", letterSpacing: "0.02em", verticalAlign: "bottom", animation: "heroFadeIn 0.01s linear 3.8s forwards, heroTypewriter 0.8s steps(20, end) 3.8s forwards, heroCursorFade 0.4s linear 3.8s infinite, heroCursorHide 0.01s linear 5.4s forwards" }}>{"\u201CYou did it anyway.\u201D"}</span></p>
          ...
          <p className="hero-reframe-line" style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(2.5rem, 5.5vw, 4.2rem)", fontWeight: 800, letterSpacing: "-0.06em", lineHeight: 0.9, fontVariationSettings: "'opsz' 96", textTransform: "uppercase", WebkitFontSmoothing: "antialiased", color: "#FAFAFA", marginBottom: "4px", opacity: 0, clipPath: "inset(100% 0 0 0)", WebkitClipPath: "inset(100% 0 0 0)", animation: "heroClipReveal 0.7s cubic-bezier(0.16,1,0.3,1) 5.5s forwards" }}>THAT{"\u2019"}S NOT WHO YOU ARE.</p>
          <p className="hero-reframe-line" style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(2.5rem, 5.5vw, 4.2rem)", fontWeight: 800, letterSpacing: "-0.06em", lineHeight: 0.9, fontVariationSettings: "'opsz' 96", textTransform: "uppercase", WebkitFontSmoothing: "antialiased", color: "#FAFAFA", marginBottom: "4px", opacity: 0, clipPath: "inset(100% 0 0 0)", WebkitClipPath: "inset(100% 0 0 0)", animation: "heroClipReveal 0.7s cubic-bezier(0.16,1,0.3,1) 6.0s forwards" }}>THAT{"\u2019"}S A <span style={{ background: "#14B8A6", color: "#0a0a0a", padding: "0 0.15em", display: "inline", lineHeight: "inherit" }}>PATTERN</span> RUNNING.</p>
          ...
          <div style={{ marginBottom: "16px" }}><span className="hero-pivot-line" data-testid="text-brand-title" style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic", fontWeight: 400, fontSize: "clamp(1.8rem, 4vw, 3rem)", color: "#14B8A6", letterSpacing: "0.02em", opacity: 0, animation: "heroTealPulse 1.2s ease 7.8s forwards" }}>THE PATTERN HAS A NAME.</span></div>
          <p data-testid="text-hero-positioning" className="hero-subtext" style={{ fontFamily: "'Inter', sans-serif", fontSize: "1.05rem", color: "rgba(250,250,250,0.55)", marginBottom: "32px", lineHeight: 1.8, opacity: 0, animation: "heroRevealUp 0.6s ease 9.0s forwards" }}>Your body sends a signal <span className="hero-searchlight">3 to 7 seconds</span> before it fires. That signal is learnable. This is the method.</p>
