    ...
    <div ref={pageRef} className="min-h-screen thread-page" style={{ background: "#0A0A0A", color: "#F5F5F5", fontFamily: "'Inter', sans-serif", overflowX: "hidden" }}>
      ...
      <section className="min-h-screen relative hero-section-fade hero-grid" data-testid="section-hero" style={{ overflow: "hidden" }}>
        ...
        <div className="hero-content-col">
          ...
          <div className="hero-rule hero-rule-2" style={{ height: "1px", width: "40px", background: "#14B8A6", margin: "16px 0", opacity: 0, animation: "heroFadeIn 0.5s ease 5.0s forwards" }} />
          ...
          <div className="hero-rule hero-rule-3" style={{ height: "1px", width: "40px", background: "#14B8A6", margin: "14px 0", opacity: 0, animation: "heroFadeIn 0.5s ease 7.2s forwards" }} />
          <div className="hero-pivot-wrap" style={{ marginBottom: "16px" }}><span className="hero-pivot-line" data-testid="text-brand-title" style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontWeight: 400, fontSize: "clamp(1.8rem, 4vw, 3rem)", color: "#14B8A6", letterSpacing: "0.02em", opacity: 0, visibility: "hidden", animation: "heroTealPulse 1.2s ease 7.8s forwards" }}>THE PATTERN HAS A NAME.</span></div>
