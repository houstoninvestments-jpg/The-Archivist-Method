    ...
    >
      ...
      <div style={{ maxWidth: "640px", width: "100%", padding: "80px 24px 64px", margin: "0 auto" }}>
        <div className="text-center" style={{ marginBottom: "48px" }}>
          ...
          <p style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontWeight: 400, fontSize: "1.05rem", color: "#14B8A6", maxWidth: "480px", margin: "0 auto", lineHeight: 1.7 }}>
          ...
          <div>
            ...
            {loading ? (
              <div className="text-center" style={{ padding: "20px 0" }}>
                <span className="animate-pulse" style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontWeight: 400, fontSize: "1rem", color: "#14B8A6" }}>
                  Reading your signal...
                </span>
              </div>
            ) : (
  ...
  return (
    ...
    >
      <div style={{ maxWidth: "700px", margin: "0 auto", textAlign: "center" }}>
        ...
        <p className="fade-section" data-testid="text-window-line2" style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontWeight: 400, fontSize: "clamp(20px, 3vw, 24px)", color: "#14B8A6", lineHeight: 1.7, maxWidth: "560px", margin: "0 auto", paddingBottom: "80px" }}>
        ...
        <p className="fade-section" data-testid="text-window-line6" style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontWeight: 400, fontSize: "clamp(20px, 3vw, 24px)", color: "#14B8A6", lineHeight: 1.7, maxWidth: "520px", margin: "0 auto", paddingBottom: "80px" }}>
    ...
    <div ref={pageRef} className="min-h-screen thread-page" style={{ background: "#0A0A0A", color: "#F5F5F5", fontFamily: "'Inter', sans-serif", overflowX: "hidden" }}>
      ...
      <section className="min-h-screen relative hero-section-fade hero-grid" data-testid="section-hero" style={{ overflow: "hidden" }}>
        <h1 style={{ position: "absolute", width: "1px", height: "1px", padding: 0, margin: "-1px", overflow: "hidden", clip: "rect(0,0,0,0)", whiteSpace: "nowrap", border: 0 }}>
          The Archivist Method — Pattern Archaeology, Not Therapy
        </h1>
        ...
        <div className="hero-content-col">
          ...
          <p className="hero-confession" style={{ marginBottom: "4px", lineHeight: 1.9 }}><span style={{ display: "inline-block", overflow: "hidden", whiteSpace: "nowrap", borderRight: "2px solid transparent", width: 0, opacity: 0, fontFamily: "'JetBrains Mono', monospace", fontSize: "0.9rem", color: "rgba(250,250,250,0.7)", letterSpacing: "0.02em", verticalAlign: "bottom", animation: "heroFadeIn 0.01s linear 3.8s both, heroTypewriter3 0.8s steps(20, end) 3.8s both, heroCursorFade 0.4s linear 3.8s infinite, heroCursorHide 0.01s linear 5.4s forwards" }}>{"\u201CYou did it anyway.\u201D"}</span></p>
          <div className="hero-rule hero-rule-2" style={{ height: "1px", width: "40px", background: "#14B8A6", margin: "16px 0", opacity: 0, animation: "heroFadeIn 0.5s ease 5.6s forwards" }} />
          <p className="hero-reframe-line" style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(2.5rem, 5.5vw, 4.2rem)", fontWeight: 800, letterSpacing: "-0.06em", lineHeight: 0.9, fontVariationSettings: "'opsz' 96", textTransform: "uppercase", WebkitFontSmoothing: "antialiased", color: "#FAFAFA", marginBottom: "4px", opacity: 0, clipPath: "inset(100% 0 0 0)", WebkitClipPath: "inset(100% 0 0 0)", animation: "heroClipReveal 0.7s cubic-bezier(0.16,1,0.3,1) 6.0s both" }}>THAT{"\u2019"}S NOT WHO YOU ARE.</p>
          <p className="hero-reframe-line" style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(2.5rem, 5.5vw, 4.2rem)", fontWeight: 800, letterSpacing: "-0.06em", lineHeight: 0.9, fontVariationSettings: "'opsz' 96", textTransform: "uppercase", WebkitFontSmoothing: "antialiased", color: "#FAFAFA", marginBottom: "4px", opacity: 0, clipPath: "inset(100% 0 0 0)", WebkitClipPath: "inset(100% 0 0 0)", animation: "heroClipReveal 0.7s cubic-bezier(0.16,1,0.3,1) 6.6s both" }}>THAT{"\u2019"}S A <span style={{ background: "#14B8A6", color: "#0a0a0a", padding: "0 0.15em", display: "inline", lineHeight: "inherit" }}>PATTERN</span> RUNNING.</p>
          <div className="hero-rule hero-rule-3" style={{ height: "1px", width: "40px", background: "#14B8A6", margin: "14px 0", opacity: 0, animation: "heroFadeIn 0.5s ease 7.6s forwards" }} />
          <div className="hero-pivot-wrap" style={{ marginBottom: "16px" }}><span className="hero-pivot-line" data-testid="text-brand-title" style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontWeight: 400, fontSize: "clamp(1.8rem, 4vw, 3rem)", color: "#14B8A6", letterSpacing: "0.02em", opacity: 0, visibility: "hidden", animation: "heroTealPulse 1.2s ease 8.0s forwards" }}>THE PATTERN HAS A NAME.</span></div>
          <p data-testid="text-hero-positioning" className="hero-subtext" style={{ fontFamily: "'Inter', sans-serif", fontSize: "1.05rem", color: "rgba(250,250,250,0.55)", marginBottom: "32px", lineHeight: 1.8, opacity: 0, animation: "heroRevealUp 0.6s ease 9.0s both" }}>Your body sends a signal <span className="hero-searchlight">3 to 7 seconds</span> before it fires. That signal is learnable. This is the method.</p>
          <div className="hero-cta-wrap" style={{ opacity: 0, animation: "heroRevealUp 0.6s ease 10.0s forwards", marginBottom: "16px" }}><Link href="/quiz" data-testid="button-cta" className="hero-cta-pulse hero-cta-compact" style={{ display: "inline-block", fontFamily: "'JetBrains Mono', monospace", fontSize: "0.8rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#00FFC2", border: "1px solid rgba(0,255,194,0.5)", padding: "18px 48px", background: "rgba(0,255,194,0.04)", transition: "background 0.2s ease, border-color 0.2s ease", textDecoration: "none" }} onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = "rgba(0,255,194,0.08)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(0,255,194,0.9)"; (e.currentTarget as HTMLElement).style.boxShadow = "0 0 24px rgba(0,255,194,0.25)"; (e.currentTarget as HTMLElement).style.animationPlayState = "paused"; }} onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.background = "rgba(0,255,194,0.04)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(0,255,194,0.5)"; (e.currentTarget as HTMLElement).style.boxShadow = ""; (e.currentTarget as HTMLElement).style.animationPlayState = "running"; }}>IDENTIFY MY <span style={{ background: "#14B8A6", color: "#0a0a0a", padding: "0 0.12em" }}>PATTERN</span> — FREE →</Link></div>
          <div className="hero-meta-wrap" style={{ opacity: 0, animation: "heroFadeIn 0.6s ease 10.8s forwards" }}><p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "11px", color: "#999", textTransform: "uppercase", letterSpacing: "0.2em" }}>2 MINUTES · 9 PATTERNS · INSTANT RESULTS</p></div>
        </div>
      </section>
      ...
      <section className="py-20 px-6" data-testid="section-gut-check" style={{ position: "relative" }}>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="fade-section" style={{ fontFamily: "'DM Serif Display', serif", fontWeight: 400, color: "#14B8A6", fontStyle: "italic", fontSize: "1.125rem", maxWidth: "500px", margin: "0 auto", lineHeight: 1.5 }}>
      ...
      <section className="py-20" data-testid="section-patterns" style={{ position: "relative" }}>
        ...
        <div className="px-8 md:px-16" style={{ marginLeft: "auto", marginRight: "auto", maxWidth: "1100px", width: "100%" }}>
          <div className="text-center" style={{ marginBottom: "48px" }}>
            ...
            <p className="fade-section fade-delay-2 mx-auto" style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontWeight: 400, fontSize: "1.125rem", color: "#14B8A6", maxWidth: "500px", marginTop: "20px", marginBottom: "40px" }} data-testid="text-patterns-subline">
          ...
          <p className="fade-section fade-delay-3 text-center mx-auto" style={{ fontFamily: "'DM Serif Display', serif", fontWeight: 400, fontSize: "1.125rem", color: "#14B8A6", fontStyle: "italic", maxWidth: "500px", marginTop: "48px" }} data-testid="text-patterns-footer">
      ...
      <section className="pt-20 pb-10 px-6" data-testid="section-cta-break" style={{ position: "relative" }}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontWeight: 400, fontSize: "1.15rem", color: "#14B8A6", lineHeight: 1.7, maxWidth: "600px", margin: "0 auto 32px" }}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { num: "3", name: "INSTALL THE REWRITE", desc: "Each interrupt weakens the pattern. Every one builds a new path in your brain. The pattern doesn't vanish — it loses its grip. You get your choices back." },
            ].map((step, i) => (
              <div
                key={step.num}
        ...
        <div className="max-w-6xl mx-auto" style={{ position: "relative" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="fade-section">
              ...
              <p style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontWeight: 400, fontSize: "1.15rem", color: "#14B8A6", lineHeight: 1.65, marginBottom: "20px" }}>
            ...
            <div className="fade-section fade-delay-2" style={{ position: "relative" }}>
              ...
              <div style={{ padding: "32px 28px" }}>
                ...
                <div style={{ marginTop: "20px", paddingTop: "12px", borderTop: "1px solid rgba(20,184,166,0.15)", display: "flex", justifyContent: "space-between" }}>
                  <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", color: "#333", letterSpacing: "0.1em" }}>FILE: ARCH-CORE-001</p>
      ...
      <section className="py-20 px-6" data-testid="section-bento-preview" style={{ position: "relative" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto" }}>
          <div className="text-center" style={{ marginBottom: "56px" }}>
            ...
            <p className="fade-section fade-delay-2" style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontWeight: 400, color: "#14B8A6", fontSize: "clamp(1.1rem, 2.5vw, 1.25rem)", maxWidth: "580px", margin: "0 auto" }}>
      ...
      <section className="py-20 px-6" data-testid="section-pricing" style={{ position: "relative" }}>
        <div className="max-w-6xl mx-auto">
          ...
          <p className="fade-section fade-delay-3 text-center" style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontWeight: 400, fontSize: "1.125rem", color: "#14B8A6", marginTop: "16px", opacity: 0.8 }} data-testid="text-guarantee">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="fade-section fade-delay-2 text-center">
            {[
              ...
              "So I stopped looking for more insight and started looking for the interrupt. I built the system that maps why: the 9 named patterns, and the Four Doors Protocol (Focus, Excavation, Interruption, Rewrite) that fires inside the 3-to-7-second window, not after it.",
              ...
              <p key={i} style={{
                ...
                maxWidth: "660px",
                margin: i === arr.length - 1 ? "0 auto 48px" : "0 auto 24px",
                textAlign: "center",
              }}>
                {paragraph}
              </p>
            ))}
            <p style={{ fontFamily: "'DM Serif Display', serif", fontWeight: 400, fontSize: "1.4rem", color: "#14B8A6", fontStyle: "italic", marginBottom: "20px", letterSpacing: "0.02em" }}>
              For her.
            </p>
            <p style={{ fontFamily: "'DM Serif Display', serif", fontWeight: 400, fontSize: "1.15rem", color: "rgba(250,250,250,0.4)", fontStyle: "italic", letterSpacing: "0.04em", transform: "rotate(-1.5deg)", display: "inline-block" }}>
              — Aaron
            </p>
      ...
      <section style={{ padding: "64px 24px 32px" }} data-testid="section-citations">
        <div style={{ maxWidth: "960px", margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "'DM Serif Display', serif", fontStyle: "italic", fontSize: "1.1rem", color: "#14B8A6", textAlign: "center", marginTop: "24px" }} data-testid="text-evidence-tagline">This is not self-help. This is applied neuroscience.</p>
        </div>
      </section>
      ...
      <footer style={{ padding: "48px 24px" }}>
        <div className="max-w-4xl mx-auto text-center">
          <p style={{ fontFamily: "'DM Serif Display', serif", fontWeight: 400, fontSize: "1.1rem", color: "#14B8A6", fontStyle: "italic", opacity: 0.8 }}>
          ...
          <div className="flex justify-center gap-4" style={{ marginTop: "16px" }}>
            <Link href="/terms" className="transition-colors hover:text-white" style={{ fontFamily: "'Inter', sans-serif", color: "#AAAAAA", fontSize: "12px" }} data-testid="link-terms">Terms of Service</Link>
            <span style={{ color: "#AAAAAA", fontSize: "12px" }}>&middot;</span>
            <Link href="/privacy" className="transition-colors hover:text-white" style={{ fontFamily: "'Inter', sans-serif", color: "#AAAAAA", fontSize: "12px" }} data-testid="link-privacy">Privacy Policy</Link>
            <span style={{ color: "#AAAAAA", fontSize: "12px" }}>&middot;</span>
          ...
          <div className="flex justify-center gap-5" style={{ marginTop: "20px" }} data-testid="landing-footer-social">
            {[
              { label: "TikTok", href: "https://www.tiktok.com/@archivistmethod", path: "M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5.8 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.84-.1Z" },
              { label: "Instagram", href: "https://www.instagram.com/archivistmethod", path: "M12 2.16c3.2 0 3.58.01 4.85.07 1.17.05 1.8.25 2.23.41.56.22.96.48 1.38.9.42.42.68.82.9 1.38.16.43.36 1.06.41 2.23.06 1.27.07 1.65.07 4.85s-.01 3.58-.07 4.85c-.05 1.17-.25 1.8-.41 2.23-.22.56-.48.96-.9 1.38-.42.42-.82.68-1.38.9-.43.16-1.06.36-2.23.41-1.27.06-1.65.07-4.85.07s-3.58-.01-4.85-.07c-1.17-.05-1.8-.25-2.23-.41a3.7 3.7 0 0 1-1.38-.9 3.7 3.7 0 0 1-.9-1.38c-.16-.43-.36-1.06-.41-2.23-.06-1.27-.07-1.65-.07-4.85s.01-3.58.07-4.85c.05-1.17.25-1.8.41-2.23.22-.56.48-.96.9-1.38.42-.42.82-.68 1.38-.9.43-.16 1.06-.36 2.23-.41C8.42 2.17 8.8 2.16 12 2.16zM12 0C8.74 0 8.33.01 7.05.07 5.78.13 4.9.33 4.14.63a5.9 5.9 0 0 0-2.14 1.39A5.9 5.9 0 0 0 .63 4.14C.33 4.9.13 5.78.07 7.05.01 8.33 0 8.74 0 12s.01 3.67.07 4.95c.06 1.27.26 2.15.56 2.91a5.9 5.9 0 0 0 1.39 2.14 5.9 5.9 0 0 0 2.14 1.39c.76.3 1.64.5 2.91.56C8.33 23.99 8.74 24 12 24s3.67-.01 4.95-.07c1.27-.06 2.15-.26 2.91-.56a5.9 5.9 0 0 0 2.14-1.39 5.9 5.9 0 0 0 1.39-2.14c.3-.76.5-1.64.56-2.91.06-1.28.07-1.69.07-4.95s-.01-3.67-.07-4.95c-.06-1.27-.26-2.15-.56-2.91a5.9 5.9 0 0 0-1.39-2.14A5.9 5.9 0 0 0 19.86.63C19.1.33 18.22.13 16.95.07 15.67.01 15.26 0 12 0zm0 5.84a6.16 6.16 0 1 0 0 12.32 6.16 6.16 0 0 0 0-12.32zm0 10.16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.4-11.85a1.44 1.44 0 1 0 0 2.88 1.44 1.44 0 0 0 0-2.88z" },
              { label: "YouTube", href: "https://www.youtube.com/@archivistmethod", path: "M23.5 6.2a3 3 0 0 0-2.1-2.1C19.6 3.6 12 3.6 12 3.6s-7.6 0-9.4.5A3 3 0 0 0 .5 6.2 31 31 0 0 0 0 12a31 31 0 0 0 .5 5.8 3 3 0 0 0 2.1 2.1c1.8.5 9.4.5 9.4.5s7.6 0 9.4-.5a3 3 0 0 0 2.1-2.1A31 31 0 0 0 24 12a31 31 0 0 0-.5-5.8zM9.6 15.6V8.4l6.3 3.6z" },
              { label: "X", href: "https://x.com/archivistmethod", path: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" },
              { label: "Facebook", href: "https://www.facebook.com/thearchivistmethod", path: "M22 12a10 10 0 1 0-11.56 9.88v-6.99H7.9V12h2.54V9.8c0-2.51 1.49-3.9 3.78-3.9 1.09 0 2.24.2 2.24.2v2.47h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.77l-.44 2.89h-2.33v6.99A10 10 0 0 0 22 12z" },
              { label: "LinkedIn", href: "https://www.linkedin.com/company/the-archivist-method", path: "M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.36V9h3.41v1.56h.05a3.74 3.74 0 0 1 3.37-1.85c3.6 0 4.27 2.37 4.27 5.46zM5.34 7.43a2.06 2.06 0 1 1 0-4.12 2.06 2.06 0 0 1 0 4.12zM7.12 20.45H3.56V9h3.56zM22.22 0H1.77C.79 0 0 .77 0 1.72v20.56C0 23.23.79 24 1.77 24h20.45c.98 0 1.78-.77 1.78-1.72V1.72C24 .77 23.2 0 22.22 0z" },
            ].map((s) => (
              <a
                key={s.label}
                href={s.href}
