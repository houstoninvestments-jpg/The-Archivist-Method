      ...
      <div className="container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-gradient-to-br from-archivist-teal/10 to-archivist-pink/10 border border-archivist-teal/30 rounded-lg p-8 mb-8">
            ...
            <a href="/quick-start-system.pdf" download className="inline-flex items-center gap-2 bg-archivist-teal text-archivist-dark px-8 py-4 rounded-lg font-bold text-lg" data-testid="link-download-quickstart">
          ...
          <div className="text-left bg-archivist-dark/50 border border-gray-800 rounded-lg p-6 mb-8">
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start gap-3">
                ...
                <span>All 7 destructive patterns</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-5 h-5 text-archivist-teal mt-0.5 shrink-0" />
              ...
              <li className="flex items-start gap-3">
                <Check className="w-5 h-5 text-archivist-teal mt-0.5 shrink-0" />
                <span>Circuit break library</span>
              </li>
            </ul>
          </div>
          <div className="bg-gradient-to-br from-archivist-pink/10 to-archivist-teal/10 border border-archivist-pink/30 rounded-lg p-8">
            ...
            <a href="https://buy.stripe.com/8x214f7hQdwv2augKm6c002" className="inline-flex items-center gap-2 bg-archivist-pink text-white px-8 py-4 rounded-lg font-bold text-lg" data-testid="link-upgrade-archive">
