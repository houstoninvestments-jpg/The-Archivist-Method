      ...
      <div className="container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-gradient-to-br from-archivist-teal/10 to-archivist-pink/10 border border-archivist-teal/30 rounded-lg p-8 mb-8">
            ...
            <a href="/quick-start-system.pdf" download className="inline-flex items-center gap-2 bg-archivist-teal text-archivist-dark px-8 py-4 rounded-lg font-bold text-lg hover:bg-archivist-teal/90 transition-all" data-testid="link-download-quickstart">
          ...
          <div className="bg-gradient-to-br from-archivist-pink/10 to-archivist-teal/10 border border-archivist-pink/30 rounded-lg p-8">
            ...
            <a href="https://buy.stripe.com/8x214f7hQdwv2augKm6c002" className="inline-flex items-center gap-2 bg-archivist-pink text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-archivist-pink/90 transition-all" data-testid="link-upgrade-archive">
              Upgrade to Complete Archive ($197) <ArrowRight className="w-5 h-5" />
            </a>
          </div>
        </div>
      </div>
