...
- Weight: 800 (extra bold - Inter's heaviest weight)
- Line height: 0.9 (creates tension)
- Letter spacing: -2px (tighter = more premium, architectural)
...
- Weight: 700
- Letter spacing: 2px (wider = authoritative, premium label feel)
- Color: Teal (#14B8A6)
...
```css
/* Import Inter with all weights */
@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap');

/* Hero headline - TIGHT spacing for premium feel */
.hero-title {
  font-family: 'Inter', sans-serif;
  font-size: 96px;
  font-weight: 800;
  line-height: 0.9;
  letter-spacing: -2px; /* Tight = architectural, premium */
  color: #FFFFFF;
  text-shadow: 0 4px 20px rgba(0, 0, 0, 0.5);
}

/* Tagline with glow - WIDE spacing for label/badge feel */
.hero-tagline {
  font-family: 'Inter', sans-serif;
  font-size: 32px;
  font-weight: 700;
  letter-spacing: 2px; /* Wide + uppercase = premium branding */
  text-transform: uppercase;
  color: #14B8A6;
  text-shadow: 
...
/* Mobile adjustments - maintain letter-spacing ratios */
@media (max-width: 768px) {
  .hero-title {
    font-size: 56px;
    letter-spacing: -1.5px; /* Scale proportionally */
  }
...
BEFORE (Vanilla):
- Inter font, normal weight, default spacing
...
AFTER (Premium):
- Inter 800 weight, perfect letter-spacing (-2px headline, +2px tagline)
