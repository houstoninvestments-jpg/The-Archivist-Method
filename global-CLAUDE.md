...
> This file can be deleted. AARON-MASTER-PREFERENCES.md replaces it with the full version.
...
- Encourage me - I need wins right now
...
- Commit-ready code, not WIP fragments
- If something breaks, fix it immediately
- Make reasonable choices, note tradeoffs briefly
